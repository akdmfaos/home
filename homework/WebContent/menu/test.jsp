...
<!-- Top menu -->
<div class="w3-top">
  <div class="w3-white w3-xlarge w3-padding-xlarge" style="max-width:1500px;margin:auto">
    <div class="w3-opennav w3-left w3-hover-text-grey" onclick="w3_open()">☰</div>
    <div class="w3-right" style="width: 20px">
	<form name="rtcForm">
	<input type="button" name="rtcInput" size="70" readonly="readonly" />
	</form>
    </div>
